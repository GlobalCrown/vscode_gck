...
export class GettingStartedPage extends EditorPane {
	...
	private async buildCategoriesSlide(preserveFocus?: boolean) {
		...
		const logoUri = FileAccess.asBrowserUri('vs/workbench/contrib/welcomeGettingStarted/browser/media/gckontrol_logo.png');
		const logoImg = $('img.product-logo', { src: logoUri.toString(true), alt: 'GCKontrol', width: 100, height: 100 });
